...
// display duration
static const NSTimeInterval CSToastDefaultDuration  = 1.0;
...
- (void)makeToastActivity:(id)position {
    ...
    activityView.backgroundColor = [[UIColor colorWithWhite:.2 alpha:.7] colorWithAlphaComponent:CSToastOpacity];
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (CSToastDisplayShadow) {
        wrapperView.layer.shadowColor = [UIColor colorWithWhite:.2 alpha:.7].CGColor;
        wrapperView.layer.shadowOpacity = CSToastShadowOpacity;
        wrapperView.layer.shadowRadius = CSToastShadowRadius;
        wrapperView.layer.shadowOffset = CSToastShadowOffset;
    }

    wrapperView.backgroundColor = [[UIColor colorWithWhite:.2 alpha:.7] colorWithAlphaComponent:CSToastOpacity];
